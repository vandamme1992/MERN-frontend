...
const EditPostPage = () => {
    ...
    return (
        ...
        >
            ...
            <div className='flex object-cover py-2 justify-center'>
                {oldImage && (
            ...
            <div className='flex gap-8 items-center justify-center mt-4'>
                <button
                    ...
                    className='flex justify-center items-center bg-gray-600 text-xs text-white rounded-sm py-2 px-4'>Сохранить
                    пост
                </button>
                <button
                    onClick={clearFormHandler}
                    className='flex justify-center items-center bg-red-500 text-xs text-white rounded-sm py-2 px-4'>Отменить
                </button>
            </div>
        </form>
    );
